...
My research centres on bridging automated and interactive theorem proving,
translating proof systems between different logical frameworks
through rigorous encodings in the λΠ-calculus.

I currently work on two projects developing OCaml tools
for independent verification of proofs generated by automated systems:
...
- **[`eo2lp`](https://github.com/ciaran-matthew-dunne/eo2lp/)**:
  ...
  this tool translates proof certificates from the [SMT solver](https://smt-lib.org/) [cvc5](https://cvc5.github.io/)
  to the proof assistant [LambdaPi](https://github.com/Deducteam/lambdapi),
  translating signatures and proofs from [Eunoia](https://github.com/cvc5/ethos/blob/main/user_manual.md)
  to the λΠ-calculus. See the [draft paper](files/eo2lp.pdf).
...
- **pp2lp**:
  ...
  this tool translates proof traces from the Predicate Prover used by
  [Atelier-B](https://www.atelierb.eu/en/) into LambdaPi,
  developed in collaboration with the industrial partner [CLEARSY](https://www.clearsy.com/en/).

I also contribute to [LambdaPi](https://github.com/Deducteam/lambdapi) itself,
including improvements to the LSP server
and a novel [MCP server](https://github.com/ciaran-matthew-dunne/lambdapi/tree/mcp-server)
that exposes proof-checking capabilities to AI agents.
I have authored a [Zed editor extension](https://github.com/ciaran-matthew-dunne/zed-lambdapi)
for LambdaPi with tree-sitter grammar and LSP support.
...
- **[Lambdapi MCP server](https://github.com/ciaran-matthew-dunne/lambdapi/tree/mcp-server)** --- Model Context Protocol server for AI agent integration with LambdaPi.
